...
module.exports = new function jzTree(){
     ...
     */
    jz.requirePrototype.isNativeModule = function( strModuleName ){
     ...
     * 函式補充:
          ...
          orig.module._resolveLookupPaths
              ...
              但並非如此 也不知如何使用
     */
    jz.requirePrototype.NativeModuleList = function( arrDefaultList ){
     ...
     */
    jz.requirePrototype.searchPath = function( strFileName, strDirReferencePoint ){
     ...
     * @return {String|Boolean} :
          ...
          否則為 null
     */
    jz.requirePrototype.searchPath_guessFilePath = function( strFileName ){
     ...
     * @return {null|String} :
          ...
          否則為 null
     */
    jz.requirePrototype.searchPath_guessFileExt = function( strFileName ){
        let guessFileName,
    ...
    //>> 初次種植 -----
    jz.requirePrototype.vm_forJz(
        'jzDefault Modules',
        orig.fs.readFileSync( orig.path.join( __dirname, 'rootearth/jzDefaultModules.js'), 'utf-8' )
    );
    jz.log.setMsg( jz.requirePrototype.readJSON( orig.path.join( __dirname, 'rootearth/jzLogMsg.json' ) ) );
    ...
    jz.requirePrototype.run( './rootearth/jzPlant.js', __dirname );
